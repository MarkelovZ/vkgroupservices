...
if(isset($_POST['send_message'])){
    ...
    if(empty($_POST['chat_id'])){echo'Ошибка: Эй. ID Беседы - ОБЯЗАТЕЛЬНО!! :D <br>';}
        ...
        $query = file_get_contents("https://api.vk.com/method/messages.send?chat_id=".urlencode($_POST['chat_id'])."&message=".urlencode($_POST['message'])."&sticker_id=".urlencode($_POST['stck'])."&attachment=".urlencode($_POST['attachment'])."&v=5.80&access_token=".urlencode($_POST['token']));
